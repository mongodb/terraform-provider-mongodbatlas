...
printf "\nPost-processing polymorphic docs for autogenerated resources...\n"
go run ./tools/docpostprocess --resource "${resource_name}" --models-dir tools/codegen/models --docs-dir docs
