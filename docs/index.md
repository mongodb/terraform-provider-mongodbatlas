...
For common issues and networking diagnostics, see the [Troubleshooting Guide](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/troubleshooting).
...
We have [example configurations](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples)
