...
# Data Source: mongodbatlas_service_account_project_assignments

`mongodbatlas_service_account_project_assignments` returns all Projects that the specified Service Account is assigned to.
