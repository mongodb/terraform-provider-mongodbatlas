...
- `matcher` (Attributes List) (see [below for nested schema](#nestedatt--matcher))
- `metric_threshold_config` (Attributes List) (see [below for nested schema](#nestedatt--metric_threshold_config))
- `notification` (Attributes List) (see [below for nested schema](#nestedatt--notification))
- `severity_override` (String)
- `threshold_config` (Attributes List) (see [below for nested schema](#nestedatt--threshold_config))
- `updated` (String)
