...
`mongodbatlas_online_archives` Describes the list of all the online archives for a cluster
...
* `total_count` - Count of the total number of items in the result set.
