...
**WARNING:** This data source is deprecated, use `mongodbatlas_advanced_cluster`. To learn more see the [Migration Guide: Cluster to Advanced Cluster](../guides/cluster-to-advanced-cluster-migration-guide).
