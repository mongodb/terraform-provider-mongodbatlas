...
**WARNING:** This data source is deprecated, use `mongodbatlas_advanced_cluster`. To learn more about how to migrate, please read the [Migration Guide](../guides/cluster-to-advanced-cluster-migration-guide).
