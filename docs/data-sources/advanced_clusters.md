...
This doc is for the current version of `mongodbatlas_advanced_clusters`, doc for `Preview for MongoDB Atlas Provider v2` can be found [here](./advanced_clusters%2520%2528preview%2520provider2520v2%2529).
