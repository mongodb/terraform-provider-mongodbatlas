...
* `is_native_reranking_enabled` - Flag that indicates whether Native Reranking with Voyage AI models in the Aggregation Pipeline is enabled for the project. Defaults to `false`.
...
See [MongoDB Atlas API - Project](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Projects) Documentation for more information.
