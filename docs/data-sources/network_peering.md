...
To learn more about arguments and attributes, see the [MongoDB API Network Peering Connection](https://www.mongodb.com/docs/atlas/reference/api/vpc-get-connection/) documentation.
