...
resource "mongodbatlas_stream_privatelink_endpoint" "test" {
  ...
  vendor              = "S3"
  region              = var.aws_region
  service_endpoint_id = "com.amazonaws.${var.aws_region}.s3"
}
...
- `vendor` (String) Vendor that manages the endpoint. The following are the vendor values per provider:<br>- MSK, CONFLUENT, S3 for the AWS provider.<br>- EVENTHUB and CONFLUENT for the AZURE provider.
