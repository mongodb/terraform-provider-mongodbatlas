...
***WARNING:*** For users using `mongodbatlas_advanced_cluster` resource or data sources, and defining multi sharded clusters, using this new version impacts the possibility of editing the definition of these clusters from the Atlas UI. This impact is limited to the first weeks of August 2024.
