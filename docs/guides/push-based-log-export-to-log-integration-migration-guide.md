...
For complete working examples, see the [migration examples](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/migrate_push_based_log_export_to_log_integration/).
...
- [Module maintainer example](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/migrate_push_based_log_export_to_log_integration/module_maintainer)
- [Module user example](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/migrate_push_based_log_export_to_log_integration/module_user)
...
- [Migration Examples](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/migrate_push_based_log_export_to_log_integration)
