...
- [Programmatic API Key](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Programmatic-API-Keys) Updated the following resources and data sources to make them easier to use:
  ...
  - Created a dedicated Migration Guide: Programmatic API Key to help you migrate from the previous version, which was released in Terraform Provider MongoDB Atlas in v1.8.0, to the new version in v1.10.0.
