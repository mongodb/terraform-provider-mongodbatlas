...
If you're currently utilizing `mongodbatlas_advanced_cluster` from v1.x.x of our provider, we recommend to follow these steps in order:
...
1. Upon upgrading to v2.0.0+ from v1.x.x, when you run `terraform plan`, you'll see syntax errors -- this is expected since the definition file hasn't been updated yet using the latest schema.
