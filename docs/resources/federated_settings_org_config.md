...
### Further Examples
- [Azure Federated Identity Provider with Org Config](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.16.0/examples/mongodbatlas_federated_settings_identity_provider/azure)
- [Federated Settings Org Role Mappings](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.16.0/examples/mongodbatlas_federated_settings_org_role_mapping)
