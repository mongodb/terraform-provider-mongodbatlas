...
### Further Examples
- [Migrate Project Invitation to Cloud User Project Assignment](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.14.0/examples/migrate_project_invitation_to_cloud_user_project_assignment)
