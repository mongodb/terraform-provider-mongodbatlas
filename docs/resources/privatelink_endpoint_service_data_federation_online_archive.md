...
### Further Examples
- [AWS PrivateLink for Data Federation and Online Archive](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.10.0/examples/mongodbatlas_privatelink_endpoint/aws/data-federation-online-archive)
