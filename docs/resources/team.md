...
### Further Examples
- [Team and user assignment (module maintainer) v1](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.17.0/examples/migrate_user_team_assignment/module_maintainer/v1)
- [Team and user assignment (module maintainer) v2](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.17.0/examples/migrate_user_team_assignment/module_maintainer/v2)
