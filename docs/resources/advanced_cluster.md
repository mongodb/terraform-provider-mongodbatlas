...
~> **IMPORTANT:** If upgrading from provider version 2.x to 3.0.0, please refer to the [3.0.0 Upgrade Guide](https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs/guides/3.0.0-upgrade-guide) for breaking changes affecting `mongodbatlas_advanced_cluster`.
  ...
  replication_specs = [
    {
      region_configs = [
        {
          electable_specs = {
            instance_size = "M10" # User-configured value that stays constant in state
            node_count    = 3
          }
          auto_scaling = {
...
# Use the data source to read both configured and effective values
...
output "actual_instance_size" {
  value = data.mongodbatlas_advanced_cluster.this.effective_replication_specs[0].region_configs[0].electable_specs.instance_size
}
```

-> **NOTE:** In v3.0.0, `replication_specs` children are Optional-only (not Computed), so your configured values stay constant in state. Use `effective_replication_specs` in the data source to see actual running values.
...
* [GCP Private Endpoint](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_privatelink_endpoint/gcp)
* [Azure Private Endpoint](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_privatelink_endpoint/azure)
* [AWS, Private Endpoint](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_privatelink_endpoint/aws/cluster)
* [AWS, Regionalized Private Endpoints](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_privatelink_endpoint/aws/cluster-geosharded)


### Further Examples

**Cluster Types:**
- [Replicaset](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/replicaset)
- [Symmetric Sharded Cluster](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/symmetric-sharded-cluster)
- [Asymmetric Sharded Cluster](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/asymmetric-sharded-cluster)
- [Global Cluster](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/global-cluster)
- [Multi-Cloud](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/multi-cloud)

**Auto-scaling:**
- [Auto-Scaling Per Shard](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/auto-scaling-per-shard)
- [Effective Fields Examples](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/effective_fields)

**Upgrades & Migrations:**
- [Tenant Upgrade](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/tenant-upgrade)
- [Flex Upgrade](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/flex-upgrade)
- [Version Upgrade with Pinned FCV](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/mongodbatlas_advanced_cluster/version-upgrade-with-pinned-fcv)
- [Migrate Cluster to Advanced Cluster](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.5.0/examples/migrate_cluster_to_advanced_cluster/basic)
...
When auto-scaling is enabled, Atlas automatically adjusts instance sizes and disk capacity based on workload. In v3.0.0, `replication_specs` children are Optional-only (not Computed), so your configured values stay constant in Terraform state even when Atlas auto-scales. Use the `effective_replication_specs` attribute in the data source to read actual running values.

To manually update `instance_size`, `disk_size_gb`, or `disk_iops` when auto-scaling is enabled:

1. Set `compute_enabled = false` and/or `disk_gb_enabled = false` in the [`auto_scaling`](#auto_scaling) block and apply.
...
**Legacy Option (v2.x and earlier):** Use a lifecycle ignore customization to prevent unintended changes. When auto-scaling is enabled, you must ignore all three fields (`instance_size`, `disk_size_gb`, and `disk_iops`) as Atlas may adjust any of these resources regardless of which auto-scaling type is enabled.
...
**Note:** The configuration options and considerations for analytics auto-scaling are similar to those described in [auto_scaling](#auto_scaling). Use `effective_replication_specs` in the data source to read actual scaled analytics values.
