...
* `external_id` - Unique 24-hexadecimal digit string that identifies the replication object for a shard in a Cluster. When using the new sahrding configuration, this corresponds to Shard ID displayed in the UI.
