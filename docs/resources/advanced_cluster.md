...
This doc is for the current version of `mongodbatlas_advanced_cluster`, doc for `Preview for MongoDB Atlas Provider v2` can be found [here](./advanced_cluster%2520%2528preview%2520provider2520v2%2529).
