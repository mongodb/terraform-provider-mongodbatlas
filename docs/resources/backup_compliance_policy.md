...
### Further Examples
- [Backup Compliance Policy](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.13.0/examples/mongodbatlas_backup_compliance_policy/resource)
