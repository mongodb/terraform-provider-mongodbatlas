...
`mongodbatlas_project_service_account_access_list_entry` provides an IP Access List entry resource for Project Service Accounts. The access list grants access from IPs or CIDRs to clusters within the Project.
...
For more information see: [MongoDB Atlas API Reference.](https://www.mongodb.com/docs/atlas/reference/api-resources-spec/#tag/Service-Accounts/operation/createAccessList)
