...
### Further Examples
- [Header-based](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/mongodbatlas_metric_integration/header) — export MongoDB Atlas metrics using header-based authentication.
- [OAuth 2.0](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.18.0/examples/mongodbatlas_metric_integration/oauth) — export MongoDB Atlas metrics using OAuth 2.0 authentication.
