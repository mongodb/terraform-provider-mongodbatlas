...
* `is_native_reranking_enabled` - (Optional) Flag that indicates whether to enable Native Reranking with Voyage AI models in the Aggregation Pipeline for the project. Defaults to `false`.
