...
Make sure to reference the [complete example section](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.11.0/examples/mongodbatlas_encryption_at_rest_private_endpoint/azure) for detailed steps and considerations.
...
Make sure to reference the [complete example section](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.11.0/examples/mongodbatlas_encryption_at_rest_private_endpoint/aws) for detailed steps and considerations.
...
### Further Examples
- [AWS KMS Encryption at Rest Private Endpoint](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.11.0/examples/mongodbatlas_encryption_at_rest_private_endpoint/aws)
- [Azure Key Vault Encryption at Rest Private Endpoint](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.11.0/examples/mongodbatlas_encryption_at_rest_private_endpoint/azure)
