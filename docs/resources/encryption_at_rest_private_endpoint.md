...
~> **IMPORTANT** Private Endpoint for Encryption at Rest Using Customer Key Management is in private preview, to request this functionality for you Atlas deployments contact your Account Manager. 
