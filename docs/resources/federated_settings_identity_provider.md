...
```
### Further Examples
- [Azure Federated Settings Identity Provider](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.13.0/examples/mongodbatlas_federated_settings_identity_provider/azure)
