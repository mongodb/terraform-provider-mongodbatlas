...
To manage such users with this resource, refer to our [Team Usernames Attribute to Cloud User Team Assignment Migration Guide](../guides/cloud-user-team-assignment-migration-guide).
