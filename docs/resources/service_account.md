...
The following example creates a Service Account without an Atlas-generated secret. Create the secrets with the `mongodbatlas_service_account_secret` resource.
