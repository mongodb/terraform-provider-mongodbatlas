...
### Further Examples
- [Cloud User Organization Assignment](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.0.0/examples/mongodbatlas_cloud_user_org_assignment)
