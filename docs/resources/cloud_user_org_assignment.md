...
`mongodbatlas_cloud_user_org_assignment` provides a Cloud User Org Assignment resource. The resource lets you import, assign, remove, update a user to an organization.
