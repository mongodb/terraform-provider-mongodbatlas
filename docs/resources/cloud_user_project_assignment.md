...
### Further Examples
- [Cloud User Project Assignment](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/v2.4.0/examples/mongodbatlas_cloud_user_project_assignment)
