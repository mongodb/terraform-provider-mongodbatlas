...
### Further Examples
- [Grant log access to MongoBD employees](https://github.com/mongodb/terraform-provider-mongodbatlas/tree/master/examples/mongodbatlas_mongodb_employee_access_grant)
