...
- The second resource, [`mongodbatlas_cloud_provider_access_authorization`](mongodbatlas_cloud_provider_access_authorization), helps to perform the authorization using the `role_id` of the first resource.
