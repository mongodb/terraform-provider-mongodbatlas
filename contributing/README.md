...
Thanks for your interest in contributing to MongoDB Atlas Terraform Provider, the following documents define guidelines necessary to participate in the community. Please note that we no longer develop or maintain any resources or data sources that have been marked as deprecated in our documentation[https://registry.terraform.io/providers/mongodb/mongodbatlas/latest/docs]. 
