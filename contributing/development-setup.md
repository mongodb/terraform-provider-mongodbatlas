...
- For `Private Endpoint Link` resource configuration:
  ...
  export AWS_SECURITY_GROUP_ID=<AWS_SECURITY_GROUP_ID>
  ```
~> **Notice:** For more information about the PrivateLink (for AWS only), see: https://www.mongodb.com/docs/atlas/reference/api/encryption-at-rest/https://www.mongodb.com/docs/atlas/reference/api/private-endpoint/
