...
The tag key must be `environment`. The tag value determines the wave assignment: `development` or `test` maps to Wave 1, `staging` maps to Wave 2, and `production` maps to Wave 3.
