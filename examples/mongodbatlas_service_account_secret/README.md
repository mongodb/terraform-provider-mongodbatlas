...
When you create a Service Account, Atlas automatically generates a secret. The secret value returns only once, at creation time. This example creates a second secret for the same Service Account.
