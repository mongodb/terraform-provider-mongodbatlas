...
output "user_test_conn_string" {
  value       = "mongodb+srv://${local.test_user_username}:${local.test_user_password}@${replace(mongodbatlas_advanced_cluster.this.srv_address, "mongodb+srv://", "")}/?retryWrites=true"
  sensitive   = true
