...
1. **Create a Project Service Account** with `mongodbatlas_project_service_account`.
2. **Add IP Access List entries** to the Project Service Account using `mongodbatlas_project_service_account_access_list_entry` with either CIDR blocks or IP addresses.
