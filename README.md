...
[![Coverage status](https://codecov.io/github/mongodb/terraform-provider-mongodbatlas/coverage.svg?branch=main)](https://codecov.io/github/mongodb/terraform-provider-mongodbatlas?branch=main)
