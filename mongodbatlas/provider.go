...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"mongodbatlas_private_endpoint_service_link":              dataSourceMongoDBAtlasPrivateEndpointServiceLink(),
			"mongodbatlas_private_endpoint_deprecated":                dataSourceMongoDBAtlasPrivateEndpointDeprecated(),
			"mongodbatlas_private_endpoint_interface_link_deprecated": dataSourceMongoDBAtlasPrivateEndpointInterfaceLinkDeprecated(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"mongodbatlas_private_endpoint_service_link":              resourceMongoDBAtlasPrivateEndpointServiceLink(),
			"mongodbatlas_private_endpoint_deprecated":                resourceMongoDBAtlasPrivateEndpointDeprecated(),
			"mongodbatlas_private_endpoint_interface_link_deprecated": resourceMongoDBAtlasPrivateEndpointInterfaceLinkDeprecated(),
