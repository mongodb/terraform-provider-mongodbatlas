...
func dataSourceMongoDBAtlasPrivateEndpointDeprecated() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceMongoDBAtlasPrivateEndpointDeprecatedrRead,
...
func dataSourceMongoDBAtlasPrivateEndpointDeprecatedrRead(d *schema.ResourceData, meta interface{}) error {
