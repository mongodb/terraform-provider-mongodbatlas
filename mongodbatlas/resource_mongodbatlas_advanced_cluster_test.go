...
func TestClusterRSAdvancedClusterMigrateState_empty_advancedConfig(t *testing.T) {
...
func TestClusterRSAdvancedClusterV0StateUpgrade_ReplicationSpecs(t *testing.T) {
	v0State := map[string]interface{}{
		"project_id":     "test-id",
		"name":           "test-cluster",
		"cluster_type":   "REPLICASET",
