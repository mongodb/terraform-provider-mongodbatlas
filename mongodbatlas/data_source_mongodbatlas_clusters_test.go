		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet(dataSourceName, "results.0.name"),
					resource.TestCheckResourceAttr(dataSourceName, "results.0.version_release_system", "LTS"),
					resource.TestCheckResourceAttr(dataSourceName, "results.0.advanced_configuration.0.fail_index_key_too_long", "true"),
					resource.TestCheckResourceAttr(dataSourceName, "results.0.advanced_configuration.0.javascript_enabled", "true"),
					...
					resource.TestCheckResourceAttr(dataSourceName, "results.0.advanced_configuration.0.sample_size_bi_connector", "110"),
				),
			},
		},
	})
