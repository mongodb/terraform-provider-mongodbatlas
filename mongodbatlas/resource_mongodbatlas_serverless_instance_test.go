		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.0.key", "key 1"),
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.0.value", "value 1"),
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.1.key", "key 2"),
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.1.value", "value 2"),
				),
			},
			{
				Config: testAccMongoDBAtlasServerlessInstanceConfigWithTags(orgID, projectName, instanceName, []matlas.Tag{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.0.key", "key 3"),
					resource.TestCheckResourceAttr(dataSourceInstancesName, "results.0.tags.0.value", "value 3"),
				),
			},
		},
	})
