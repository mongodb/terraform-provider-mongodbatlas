...
7. **Complementary artifacts** (honoring the artifact selection):
   ...
   - **Examples** — `examples/mongodbatlas_<name>/`, following `pr-and-documentation-standards`. Prerequisite third-party resources are defined inline or as input variables with best-effort realistic values, flagged for the author.
