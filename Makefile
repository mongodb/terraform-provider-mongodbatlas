...
generate-resource-code: ## Generate the code of autogenerated resources
...
generate-doc: ## Auto-generate the documentation for a resource
	@scripts/docs/generate-doc.sh ${resource_name}
...
# generate the code using `generate-resource-code`.
...
generate-docs-all: ## Auto-generate the documentation for all resources
	@scripts/docs/generate-docs-all.sh
