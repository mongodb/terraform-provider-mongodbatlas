...
.PHONY: resource-code-generation
resource-code-generation: ## Generate resource code from API spec (resource_name optional)
...
# generate the code using `resource-generation-pipeline`.
