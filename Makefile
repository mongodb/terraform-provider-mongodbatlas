...
## generate the code of autogenerated resources
...
.PHONY: generate-resource-code
generate-resource-code: 
	@go run ./tools/codegen/main.go $(resource_name)

# generates all code and documentation for resources defined in tools/codegen/config.yaml
