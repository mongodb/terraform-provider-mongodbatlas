...
* `mongo_db_major_version` - (Optional) (Optional) Version of the cluster to deploy. Atlas supports the following MongoDB versions for M10+ clusters: `4.0`, `4.2`, `4.4`, or 5.0. If omitted, Atlas deploys a cluster that runs MongoDB 4.4. If an M0, M2 or M5 Atlas deploys MongoDB 4.4. Atlas always deploys the cluster with the latest stable release of the specified version.
