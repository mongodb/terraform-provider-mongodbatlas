...
* `provider_disk_type_name` - (Optional) Azure disk type of the server’s root volume. If ommitted, Atlas uses the default disk type for the selected providerSettings.instanceSizeName.
