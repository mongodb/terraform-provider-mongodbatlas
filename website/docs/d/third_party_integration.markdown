...
description: |-
    Describes all Third-Party service integrations in the project.
---

# mongodbatlas_third_party_integration

`mongodbatlas_third_party_integration` describe a Third-Party service integration for the given type.
