...
* `tags` - Map that contains key-value pairs between 1 to 255 characters in length for tagging and categorizing the cluster. To learn more, see [Resource Tags](https://www.mongodb.com/docs/atlas/tags/)
