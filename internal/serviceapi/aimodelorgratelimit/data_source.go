...
func DataSource() datasource.DataSource {
	return &ds{
		DSCommon: config.DSCommon{
			DataSourceName: "ai_model_org_rate_limit",
		},
	}
}
...
func dataSourceReadAPICallParams(model *TFDSModel) *config.APICallParams {
	...
	return &config.APICallParams{
		...
		RelativePath:  "/api/atlas/v2/orgs/{orgId}/aiModelApiClouds/{cloud}/geographies/{geography}/modelGroupNames/{modelGroupName}/rateLimits",
