				...
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"oauth": dsschema.SingleNestedAttribute{
							...
							CustomType:          customtypes.NewObjectType[TFPluralDSResultsOauthModel](ctx),
							Attributes: map[string]dsschema.Attribute{
								...
								"signing_key_info": dsschema.SingleNestedAttribute{
									...
									CustomType:          customtypes.NewObjectType[TFPluralDSResultsOauthSigningKeyInfoModel](ctx),
									Attributes: map[string]dsschema.Attribute{
...
type TFPluralDSResultsModel struct {
	...
	Oauth                  customtypes.ObjectValue[TFPluralDSResultsOauthModel]               `tfsdk:"oauth" autogen:"omitjson"`
	ProviderType           types.String                                                       `tfsdk:"provider_type" autogen:"omitjson"`
}
...
type TFPluralDSResultsOauthModel struct {
	...
	SigningKeyInfo     customtypes.ObjectValue[TFPluralDSResultsOauthSigningKeyInfoModel] `tfsdk:"signing_key_info" autogen:"omitjson"`
...
type TFPluralDSResultsOauthSigningKeyInfoModel struct {
