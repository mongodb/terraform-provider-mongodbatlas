	...
	return dsschema.Schema{
		Attributes: map[string]dsschema.Attribute{
			...
			"results": dsschema.ListNestedAttribute{
				Computed:   true,
				CustomType: customtypes.NewNestedListType[TFResultsModel](ctx),
...
type TFPluralDSModel struct {
	...
	Results customtypes.NestedListValue[TFResultsModel] `tfsdk:"results" autogen:"omitjson"`
}
type TFResultsModel struct {
