	...
	return dsschema.Schema{
		Attributes: map[string]dsschema.Attribute{
			...
			"associated_orgs": dsschema.SetNestedAttribute{
				...
				CustomType:          customtypes.NewNestedSetType[TFDSAssociatedOrgsModel](ctx),
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"role_mappings": dsschema.SetNestedAttribute{
							...
							CustomType:          customtypes.NewNestedSetType[TFDSAssociatedOrgsRoleMappingsModel](ctx),
							NestedObject: dsschema.NestedAttributeObject{
								Attributes: map[string]dsschema.Attribute{
									...
									"role_assignments": dsschema.SetNestedAttribute{
										...
										CustomType:          customtypes.NewNestedSetType[TFDSAssociatedOrgsRoleMappingsRoleAssignmentsModel](ctx),
										NestedObject: dsschema.NestedAttributeObject{
											Attributes: map[string]dsschema.Attribute{
						...
						"user_conflicts": dsschema.ListNestedAttribute{
							...
							CustomType:          customtypes.NewNestedListType[TFDSAssociatedOrgsUserConflictsModel](ctx),
							NestedObject: dsschema.NestedAttributeObject{
								Attributes: map[string]dsschema.Attribute{
			...
			"pem_file_info": dsschema.SingleNestedAttribute{
				...
				CustomType:          customtypes.NewObjectType[TFDSPemFileInfoModel](ctx),
				Attributes: map[string]dsschema.Attribute{
					"certificates": dsschema.ListNestedAttribute{
						Computed:            true,
						MarkdownDescription: "List of certificates in the file.",
						CustomType:          customtypes.NewNestedListType[TFDSPemFileInfoCertificatesModel](ctx),
						NestedObject: dsschema.NestedAttributeObject{
							Attributes: map[string]dsschema.Attribute{
...
type TFDSModel struct {
	...
	AssociatedOrgs             customtypes.NestedSetValue[TFDSAssociatedOrgsModel] `tfsdk:"associated_orgs" autogen:"omitjson"`
	...
	PemFileInfo                customtypes.ObjectValue[TFDSPemFileInfoModel]       `tfsdk:"pem_file_info" autogen:"omitjson"`
...
type TFDSAssociatedOrgsModel struct {
	...
	RoleMappings                  customtypes.NestedSetValue[TFDSAssociatedOrgsRoleMappingsModel]   `tfsdk:"role_mappings" autogen:"omitjson"`
	UserConflicts                 customtypes.NestedListValue[TFDSAssociatedOrgsUserConflictsModel] `tfsdk:"user_conflicts" autogen:"omitjson"`
	Id                            types.String                                                      `tfsdk:"id" apiname:"identityProviderId" autogen:"omitjson"`
...
type TFDSAssociatedOrgsRoleMappingsModel struct {
	ExternalGroupName types.String                                                                   `tfsdk:"external_group_name" autogen:"omitjson"`
	Id                types.String                                                                   `tfsdk:"id" autogen:"omitjson"`
	RoleAssignments   customtypes.NestedSetValue[TFDSAssociatedOrgsRoleMappingsRoleAssignmentsModel] `tfsdk:"role_assignments" autogen:"omitjson"`
}
type TFDSAssociatedOrgsRoleMappingsRoleAssignmentsModel struct {
	GroupId types.String `tfsdk:"group_id" autogen:"omitjson"`
	OrgId   types.String `tfsdk:"org_id" autogen:"omitjson"`
	Role    types.String `tfsdk:"role" autogen:"omitjson"`
}
type TFDSAssociatedOrgsUserConflictsModel struct {
...
type TFDSPemFileInfoModel struct {
	Certificates customtypes.NestedListValue[TFDSPemFileInfoCertificatesModel] `tfsdk:"certificates" autogen:"omitjson"`
	FileName     types.String                                                  `tfsdk:"file_name" autogen:"omitjson"`
}
type TFDSPemFileInfoCertificatesModel struct {
