...
func Resource() resource.Resource {
	return &rs{
		RSCommon: config.RSCommon{
			ResourceName: "project_mcp_config_secret",
		},
	}
}
...
func (r *rs) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	pathParams := map[string]string{
		...
		"mcpConfigId": plan.McpConfigId.ValueString(),
	}
	callParams := config.APICallParams{
		VersionHeader: apiVersionHeader,
		RelativePath:  "/api/atlas/v2/groups/{projectId}/mcpConfigs/{mcpConfigId}/secrets",
...
func (r *rs) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	idAttributes := []string{"project_id", "mcp_config_id", "secret_id"}
...
func readAPICallParams(model any) *config.APICallParams {
	...
	pathParams := map[string]string{
		...
		"mcpConfigId": m.McpConfigId.ValueString(),
		"secretId":    m.SecretId.ValueString(),
	}
	return &config.APICallParams{
		VersionHeader: apiVersionHeader,
		RelativePath:  "/api/atlas/v2/groups/{projectId}/mcpConfigs/{mcpConfigId}/secrets/{secretId}",
		PathParams:    pathParams,
		Method:        "GET",
	}
}
