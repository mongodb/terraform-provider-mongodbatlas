...
func Resource() resource.Resource {
	return &rs{
		RSCommon: config.RSCommon{
			ResourceName: "cluster_overload_simulation",
		},
	}
}
...
func (r *rs) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	callParams := config.APICallParams{
		...
		RelativePath:  "/api/atlas/v2/groups/{projectId}/clusters/{clusterName}/overloadSimulations",
...
func (r *rs) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	reqHandle.Wait = &autogen.WaitReq{
		StateProperty:     "state",
		PendingStates:     []string{"PENDING", "ACTIVE", "FAILED", "ENDING", "COMPLETED"},
...
func (r *rs) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	idAttributes := []string{"project_id", "cluster_name", "simulation_id"}
...
func readAPICallParams(model any) *config.APICallParams {
	...
	pathParams := map[string]string{
		...
		"simulationId": m.SimulationId.ValueString(),
	}
...
func formatIDAttributes(model any) string {
	m := model.(*TFModel)
	return fmt.Sprintf("project_id=%q, cluster_name=%q, simulation_id=%q",
		m.ProjectId.ValueString(),
		m.ClusterName.ValueString(),
		m.SimulationId.ValueString(),
	)
}
