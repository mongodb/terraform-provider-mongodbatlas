...
func (r *rs) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	callParams := config.APICallParams{
		...
		RelativePath:  "/api/atlas/v2/groups/{projectId}/privateNetworkSettings/endpointIds",
...
func readAPICallParams(model any) *config.APICallParams {
	...
	pathParams := map[string]string{
		...
		"endpointId": m.EndpointId.ValueString(),
	}
	return &config.APICallParams{
		VersionHeader: apiVersionHeader,
		RelativePath:  "/api/atlas/v2/groups/{projectId}/privateNetworkSettings/endpointIds/{endpointId}",
		PathParams:    pathParams,
		Method:        "GET",
	}
}
