...
func Resource() resource.Resource {
	return &rs{
		RSCommon: config.RSCommon{
			ResourceName: "encryption_at_rest_api",
		},
	}
}
...
func (r *rs) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	callParams := config.APICallParams{
		...
		RelativePath:  "/api/atlas/v2/groups/{projectId}/encryptionAtRest",
...
func deleteRequest(r *rs, client *config.MongoDBClient, model *TFModel, diags *diag.Diagnostics) *autogen.HandleDeleteReq {
	...
	return &autogen.HandleDeleteReq{
		...
		StaticRequestBody: `{"awsKms": {"enabled": false}, "azureKeyVault": {"enabled": false}, "googleCloudKms": {"enabled": false}}`,
	}
}
