...
func Resource() resource.Resource {
	return &rs{
		RSCommon: config.RSCommon{
			ResourceName: "project_mcp_config",
		},
	}
}
...
func (r *rs) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	callParams := config.APICallParams{
		...
		RelativePath:  "/api/atlas/v2/groups/{projectId}/mcpConfigs",
...
func (r *rs) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	pathParams := map[string]string{
		...
		"mcpConfigId": state.McpConfigId.ValueString(),
	}
	callParams := config.APICallParams{
		VersionHeader: apiVersionHeader,
		RelativePath:  "/api/atlas/v2/groups/{projectId}/mcpConfigs/{mcpConfigId}",
		PathParams:    pathParams,
		Method:        "PATCH",
	}
...
func (r *rs) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	idAttributes := []string{"project_id", "mcp_config_id"}
