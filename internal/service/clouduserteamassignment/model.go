...
func NewTFModel(ctx context.Context, apiResp *admin.CloudUserTeamAssignment) (*TFModel, diag.Diagnostics) {
...
func NewAtlasReq(ctx context.Context, plan *TFModel) (*admin.CloudUserTeamAssignment, diag.Diagnostics) {
	// var tfList []complexArgumentData
	// resp.Diagnostics.Append(plan.ComplexArgument.ElementsAs(ctx, &tfList, false)...)
	// if resp.Diagnostics.HasError() {
	// 	return nil, diagnostics
	// }
	return &admin.CloudUserTeamAssignment{}, nil
}
