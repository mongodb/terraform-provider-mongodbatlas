...
var ActionsObjType = types.ObjectType{AttrTypes: map[string]attr.Type{
...
var ResourcesObjType = types.ObjectType{AttrTypes: map[string]attr.Type{
	"cluster":    types.BoolType,
...
var InheritedRolesObjType = types.ObjectType{AttrTypes: map[string]attr.Type{
	"db":   types.StringType,
