...
// Omit empty autoscaling children generated by the converter.
// Infinite rejects diskGB even when empty; compute has no edition-specific rejection.
func omitEmptyComputeAndDiskGB(autoScaling *admin.AdvancedAutoScalingSettings) {
	if autoScaling == nil {
		return
	}
