...
func NewTFEmployeeAccess(ctx context.Context, apiResp *admin.EmployeeAccessGrant) (*TFEmployeeAccessRSModel, diag.Diagnostics) {
	// complexAttr, diagnostics := types.ListValueFrom(ctx, InnerObjectType, newTFComplexAttrModel(apiResp.ComplexAttr))
	// if diagnostics.HasError() {
	// 	return nil, diagnostics
	// }
	return &TFEmployeeAccessRSModel{}, nil
}
...
func NewEmployeeAccessReq(ctx context.Context, plan *TFEmployeeAccessRSModel) (*admin.EmployeeAccessGrant, diag.Diagnostics) {
