...
func TestAccPushBasedLogExportRS_basic(t *testing.T) {

	resource.ParallelTest(t, resource.TestCase{
		PreCheck:                 func() { acc.PreCheckBasic(t) },
		ProtoV6ProviderFactories: acc.TestAccProviderV6Factories,
//		CheckDestroy:             checkDestroyPushBasedLogExport,
		Steps: []resource.TestStep{ // TODO: verify updates and import in case of resources
//			{
//				Config: pushBasedLogExportConfig(),
//				Check:  pushBasedLogExportAttributeChecks(),
//			},
//          {
//				Config: pushBasedLogExportConfig(),
//				Check:  pushBasedLogExportAttributeChecks(),
...
//				ImportStateIdFunc: checkPushBasedLogExportImportStateIDFunc,
//				ImportState:       true,
