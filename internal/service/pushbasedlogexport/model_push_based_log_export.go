...
func NewTFPushBasedLogExport(ctx context.Context, apiResp *admin.PushBasedLogExport) (*TFPushBasedLogExportModel, diag.Diagnostics) {
	// complexAttr, diagnostics := types.ListValueFrom(ctx, InnerObjectType, newTFComplexAttrModel(apiResp.ComplexAttr))
	// if diagnostics.HasError() {
	// 	return nil, diagnostics
	// }
	return &TFPushBasedLogExportModel{}, nil
}
...
func NewPushBasedLogExportReq(ctx context.Context, plan *TFPushBasedLogExportModel) (*admin.PushBasedLogExport, diag.Diagnostics) {
    // var tfList []complexArgumentData
	// resp.Diagnostics.Append(plan.ComplexArgument.ElementsAs(ctx, &tfList, false)...)
	// if resp.Diagnostics.HasError() {
	// 	return nil, diagnostics
	// }
	return &admin.PushBasedLogExport{}, nil
}
