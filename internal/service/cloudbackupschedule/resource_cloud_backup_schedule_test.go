...
func TestAccBackupRSCloudBackupSchedule_copySettings(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: configCopySettings(terraformStr, projectID, clusterResourceName, false, &admin20240530.DiskBackupSnapshotSchedule{
					ReferenceHourOfDay:    conversion.Pointer(3),
					ReferenceMinuteOfHour: conversion.Pointer(45),
			...
			{
				Config: configCopySettings(terraformStr, projectID, clusterResourceName, true, &admin20240530.DiskBackupSnapshotSchedule{
					ReferenceHourOfDay:    conversion.Pointer(3),
					ReferenceMinuteOfHour: conversion.Pointer(45),
					RestoreWindowDays:     conversion.Pointer(1),
				}),
...
func configCopySettings(terraformStr, projectID, clusterResourceName string, emptyCopySettings bool, p *admin20240530.DiskBackupSnapshotSchedule) string {
