		...
		Steps: []resource.TestStep{
			{
				...
				Check: checkAggrDS(
					...
					resource.TestCheckResourceAttrSet(datasourceName, "users.0.roles.org_roles.#"),
					...
					resource.TestCheckResourceAttrSet(pluralDSName, "results.0.users.0.roles.org_roles.#"),
				),
			},
		},
	})
