...
const (
	tfplugindocsMarker = "<!-- schema generated by tfplugindocs -->"
	postProcessMarker  = "<!-- polymorphic attributes restructured by docpostprocess -->"
)
...
// All other content is preserved exactly as-is. Returns the (possibly modified)
// content and whether any restructuring was applied.
func RestructurePolymorphicDocs(content string) (string, bool) {
	...
	return applyReplacements(lines, replacements), true
}
